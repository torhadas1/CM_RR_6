...
var myChart = new Chart(ctx, {
    ...
    data: {
        ...
        datasets: [{
            ...
            backgroundColor: ['rgba(75, 192, 192, 0.6)', 'rgba(255, 206, 86, 0.6)', 'rgba(54, 162, 235, 0.6)', 'rgba(255, 99, 132, 0.6)'],
...
function updateChart() {
    var mistveilCoyotes = document.getElementById('7. Graph - Mistveil Coyotes').value || 0;
    var bluebellCoyotes = document.getElementById('7. Graph - Bluebell Coyotes').value || 0;
    var mistveilIllness = document.getElementById('7. Graph - Mistveil Illness').value || 0;
    var bluebellIllness = document.getElementById('7. Graph - Bluebell Illness').value || 0;

    myChart.data.datasets[0].data = [mistveilCoyotes, bluebellCoyotes, mistveilIllness, bluebellIllness];
    myChart.update();
}


// Add input event listeners to all input fields
document.getElementById('7. Graph - Mistveil Coyotes').addEventListener('input', updateChart);
document.getElementById('7. Graph - Bluebell Coyotes').addEventListener('input', updateChart);
document.getElementById('7. Graph - Mistveil Illness').addEventListener('input', updateChart);
document.getElementById('7. Graph - Bluebell Illness').addEventListener('input', updateChart);
